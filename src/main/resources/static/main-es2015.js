...
let KardexComponent = class KardexComponent {
    ...
    buy() {
        this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + '/products/buy', this.buyForm.value).subscribe((success) => {
            this.loadProducts();
            this.buyForm.reset();
    ...
    sell() {
        this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + '/products/sell', this.sellForm.value).subscribe((success) => {
            this.loadProducts();
            this.sellForm.reset();
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
                title: 'Muy bien!',
    ...
    changeProductBuy($event) {
        this.productBuy = this.listProducts.filter(
        // @ts-ignore
        // tslint:disable-next-line:triple-equals
        product => product.idProduct == $event.target.value)[0];
    }
    changeProductSell($event) {
    ...
    loadProducts() {
        // Load products
        this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + '/products').subscribe((success) => {
            // @ts-ignore
...
let ProductComponent = class ProductComponent {
    ...
    saveProduct() {
        this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/products', this.productForm.value).subscribe((success) => {
